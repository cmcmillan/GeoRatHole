...
public class Main
{
    ...
    private static final String[] globes =
    {
        "             ._o##HMP'\"\"\"&&Z##o_",
        "          _od'`\"\"' \"\"?\\ HMM9MMMMMHb_",
    ...
    private static final int OFFSET = 43200;
    private static final int SECSPERDAY = 86400;
    private static final int NGLOBES = 30;
    private static final int NLINES = 23;
    /**
